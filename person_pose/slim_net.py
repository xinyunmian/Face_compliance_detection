...
class PoseNet(nn.Module):
    def __init__(self):
        ...
        self.conv5 = conv_dw(32, 32, 1)
        self.conv6 = conv_dw(32, 32, 1)
        self.conv7 = conv_dw(32, 48, 2)
        self.conv8 = conv_dw(48, 48, 2)
        self.conv9 = conv_dw(48, 48, 1)
        self.conv10 = conv_dw(48, 64, 2)
        self.conv11 = conv_dw(64, 64, 2)
        self.conv12 = conv_dw(64, 64, 1)
        self.conv13 = conv_dw(64, 128, 2)
        self.conv14 = conv_dw(128, 128, 1)
        self.conv15 = conv_dw(128, 128, 1)

        self.fc_out = nn.Linear(in_features=2 * 2 * 128, out_features=3)
...
if __name__ == "__main__":
    ...
    _weight = "weights/pose_0813.pth"  # 需要修改
    ...
    saveparams.forward("pose_param_cfg.h", "pose_param_src.h")
