...
if __name__ == '__main__':
    ...
    netW = 256
    netH = 256
    weight_path = "weights/pose_300.pth"
    # load weight
    ...
    ##################export###############
    output_onnx = 'D:/codes/pytorch_projects/pytorch2ncnn/pose.onnx'  #统一在该文件夹下转换
    ...
    sim_onnx = 'D:/codes/pytorch_projects/pytorch2ncnn/pose_simplify.onnx'
