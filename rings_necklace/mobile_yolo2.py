...
class conv_dw2(nn.Module):
    def __init__(self, inp, oup, k=3, s=1, p=1):
        super(conv_dw2, self).__init__()
...
class SlimNet(nn.Module):
    def __init__(self, cfg):
        ...
        self.conv1 = conv_dw2(inp=3, oup=self.outc[0], s=2)
        self.conv2 = conv_dw2(inp=self.outc[0], oup=self.outc[0], s=1)
        self.conv3 = conv_dw2(inp=self.outc[0], oup=self.outc[0], s=1)
        self.conv4 = conv_dw2(inp=self.outc[0], oup=self.outc[1], s=2)
        self.conv5 = conv_dw2(inp=self.outc[1], oup=self.outc[1], s=1)
        self.conv6 = conv_dw2(inp=self.outc[1], oup=self.outc[1], s=1)
        self.conv7 = conv_dw2(inp=self.outc[1], oup=self.outc[2], s=2)
        self.conv8 = conv_dw2(inp=self.outc[2], oup=self.outc[2], s=1)
        self.conv9 = conv_dw2(inp=self.outc[2], oup=self.outc[2], s=1)  # b 64 24 24

        self.conv10 = conv_dw2(inp=self.outc[2], oup=self.outc[3], s=2)
        self.conv11 = conv_dw2(inp=self.outc[3], oup=self.outc[3], s=1)
        self.conv12 = conv_dw2(inp=self.outc[3], oup=self.outc[3], s=1)  # b 96 12 12

        self.conv13 = conv_dw2(inp=self.outc[3], oup=self.outc[4], s=2)
        self.conv14 = conv_dw2(inp=self.outc[4], oup=self.outc[4], s=1)
        self.conv15 = conv_dw2(inp=self.outc[4], oup=self.outc[4], s=1)  # b 128 6 6
        self.head = YoloHead(inchannel=self.outc[4], outchannel=self.targetc)
