...
if __name__ == '__main__':
    ...
    # net = FaceDetectSlimNet(cfg=cfg_slimNet3)
    netW = 640
    netH = 640
    # weight_path = "weights/face_slim_0609_250.pth"
    # # load weight
    ...
    #
    # ##################export###############
    # output_onnx = 'D:/codes/pytorch_projects/pytorch2ncnn/FaceSlim_20210609.onnx'  #统一在该文件夹下转换
    ...
    # import onnx
    #
    # sim_onnx = 'D:/codes/pytorch_projects/pytorch2ncnn/FaceSlim_20210609_simplify.onnx'
