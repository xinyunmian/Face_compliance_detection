...
class FaceQualityNet(nn.Module):
    def __init__(self, channels=[16, 32, 64, 128, 256], lda_outc=64):
    ...
    def forward(self, x):
        ...
        # b, c= x.shape
        # save_feature_channel("txt/catp.txt", x, b, c, 0, 0)
        out = self.target(x)
        return out
...
if __name__ == "__main__":
    ...
    net.eval()
    img_path = "D:/data/imgs/facePicture/blur/11.jpg"
    ...
    img_mat = img_mat.unsqueeze(0).cpu()
