...
def get_boxes_yolo2_type(output, anchors, num_anchors, num_classes, conf_thresh, use_sigmoid):
...
def test_one(img_mat, dnet):
    ...
    outdata = dnet(img)
    output = outdata.data
    boxes = get_boxes_yolo2_type(output, conf_thresh=traincfg.conf_thresh, num_classes=2, anchors=traincfg.anchors,
...
if __name__ == "__main__":
    ...
    weight_path = "weights/ears_20210602_20.pth"
    ...
    img_path = "D:/codes/pytorch_projects/yolo/imgs/occ_clip_big.bmp"
